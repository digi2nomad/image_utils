...
def create_thumbnail(text,
    ...
    draw.text((100,1250), "A princeling explains",  
              font=ImageFont.truetype("font/Gendy.otf", 155), fill="yellow") 
    draw.text((100,1420), "to the West",  
              font=ImageFont.truetype("font/Gendy.otf", 155), fill="yellow") 
    draw.text((100,1590), "How China succeeded",  
              font=ImageFont.truetype("font/Gendy.otf", 155), fill="yellow") 
